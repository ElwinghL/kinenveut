        ...
        <div class="col-md-6">
          <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              ...
              <a class="dropdown-item" href="?r=accessRequest/index">Demandes <?php if (isset($nbDemandes)) : ?><span class="badge <?=($nbDemandes > 0) ? 'badge-danger' : 'badge-secondary';?> badge-pill"><?= $nbDemandes; ?></span><?php endif; ?></a>
