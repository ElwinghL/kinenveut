        ...
        <div class="card-body">
            <form action="?r=registration/register" method="post">
                ...
                <div class="form-group col-md-10">
                    ...
                    <input class="form-control" name="firstName" type="text" id="firstName" value="<?php if(isset($firstName)){ echo $firstName; } echo(""); ?>" placeholder="" maxlength="100" required/>

                    <br/>

                    <label for="lastName">Nom</label>
                    <input class="form-control" name="lastName" type="text" value="<?php if(isset($lastName)){ echo $lastName; } echo(""); ?>" placeholder="" maxlength="100" required/>

                    <br/>

                    <label for="birthDate">Date de naissance</label>
                    <input class="form-control" name="birthDate" type="date" value="<?php if(isset($birthDate)){ echo $birthDate; } echo(""); ?>" placeholder="" maxlength="10" required/>

                    <br/>

                    <label for="email">Email</label>
                    <input class="form-control" name="email" type="email" value="<?php if(isset($email)){ echo $email; } echo(""); ?>" placeholder="" maxlength="255" required/>
