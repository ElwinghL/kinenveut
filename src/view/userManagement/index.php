        ...
        <?php foreach ($users as $user) : ?>
          <li id="user_<?php echo $user->getId(); ?>" class="list-group-item float">
            ...
            <div class="col-md- mr-0 float-right">
              <a href="?r=account/info&id=<?php echo utf8_encode($user->getId()); ?>" class="btn btn-primary">
              ...
              <a href="?r=userManagement/validate&id=<?php echo utf8_encode($user->getId()); ?>" class="btn btn-success">
                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" d="M10.97 4.97a.75.75 0 0 1 1.071 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.236.236 0 0 1 .02-.022z" />
                </svg>
              </a>
              <a href="?r=userManagement/delete&id=<?php echo utf8_encode($user->getId()); ?>" class="btn btn-danger">
