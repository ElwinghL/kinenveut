...
VALUES
    ...
    ,(19,'Clément','Démant','clement@kinenveut.fr','1990-01-01','5f4dcc3b5aa765d61d8327deb882cf99',1,0) ##The password is : password
     #Last suscribers
    ,(20,'Manon','Tanon','manon@kinenveut.fr','1975-01-01','5f4dcc3b5aa765d61d8327deb882cf99',-1,0) ##The password is : password, she just suscribed
    ,(21,'Kevin','Souris','kevin@kinenveut.fr','1945-01-01','5f4dcc3b5aa765d61d8327deb882cf99',-1,0) ##The password is : password, he just suscribed
;
UNLOCK TABLES;
...
#Auction state : Finished/Finished earlier
     #Privacy : Public
    (1,'Fin Puppy', 'This object is Finished & Public', 0, 0, '', '2020-09-01', 7, 1, 12, 0, 1)
    ...
    ,(4,'Fin  Private', 'This object is Finished & Private', 0, 0, '', '2020-09-01', 8, 1, 15, 1, 3)
    #Privacy : Confidential
    ,(5,'Fin Confidential', 'This object is Finished & Confidential', 0, 0, '', '2020-09-01', 8, 3, 15, 2, 4)
    ,(6,'Fin My Cppupy', 'This object is Finished & Confidential', 0, 0, '', '2020-09-01', 7, 1, 9, 2, 1)

#Auction state : Canceled
    #Privacy : Public
    ,(7,'Can My P objet', 'This object is Canceled & Public', 0, 0, '', '2020-09-01', 7, 1, 3, 0, 1)
    ,(8,'Can Public', 'This object is Canceled & Public', 0, 0, '', '2020-09-01', 8, 1, 13, 15, 1)
    #Privacy : Private
    ,(9,'Can My PV objet', 'This object is Canceled & Private', 0, 0, '', '2020-09-01', 8, 1, 4, 1, 1)
    ,(10,'Can  Private', 'This object is Canceled & Private', 0, 0, '', '2020-09-01', 7, 1, 15, 1, 1)
    #Privacy : Confidential
    ,(11,'Can My C objet', 'This object is Canceled & Confidential', 0, 0, '', '2020-09-01', 7, 1, 19, 2, 1)
    ,(12,'Can Confidential', 'This object is Canceled & Confidential', 0, 0, '', '2020-09-01', 8, 1, 16, 2, 1)

#Auction state : Refused
     #Privacy : Public
     ,(13,'Ref P objet', 'This object is Refused & Public', 0, 0, '', '2020-09-01', 7, 0, 7, 0, 1)
     ,(14,'Ref Public', 'This object is Refused & Public', 0, 0, '', '2020-09-01', 8, 0, 6, 0, 1)
     #Privacy : Private
     ,(15,'Ref PV objet', 'This object is Refused & Private', 0, 0, '', '2020-09-01', 7, 0, 8, 1, 1)
     ,(16,'Ref Private', 'This object is Refused & Private', 0, 0, '', '2020-09-01', 8, 0, 5, 1, 1)
     #Privacy : Confidential
     ,(17,'Ref C objet', 'This object is Refused & Confidential', 0, 0, '', '2020-09-01', 8, 0, 7, 2, 1)
     ,(18,'Ref Confidential', 'This object is Refused & Confidential', 0, 0, '', '2020-09-01', 7, 0, 15, 2, 1)
...
#Auction state : Waiting for admin choice
    #Privacy : Public
    ,(30,'Adm P objet', 'This object is Waiting for admin choice & Public', 0, 0, '', '2020-09-01', 7, -1, 7, 0, 1)
    ,(31,'Adm Public', 'This object is Waiting for admin choice & Public', 0, 0, '', '2020-09-01', 8, -1, 6, 0, 1)
    #Privacy : Private
    ,(32,'Adm PV objet', 'This object is Waiting for admin choice & Private', 0, 0, '', '2020-09-01', 7, -1, 8, 1, 1)
    ,(33,'Adm Private', 'This object is Waiting for admin choice & Private', 0, 0, '', '2020-09-01', 8, -1, 5, 1, 1)
    #Privacy : Confidential
    ,(34,'Adm C objet', 'This object is Waiting for admin choice & Confidential', 0, 0, '', '2020-09-01', 8, -1, 7, 2, 1)
    ,(35,'Adm Confidential', 'This object is Waiting for admin choice & Confidential', 0, 0, '', '2020-09-01', 7, -1, 15, 2, 1)
;
UNLOCK TABLES;
