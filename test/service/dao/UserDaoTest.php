...
class UserDaoTest extends TestCase
{
  ...
  {
    $expectedReturn = $this->userDao->selectAllUserExceptState0();
    $isAuthorised = '1';
    $userId = $this->userDao->insertUser($this->user);
    $this->user->setId($userId);
    ...
    $this->assertTrue(is_array($usersSelected));
    $this->assertEquals($expectedReturn, count($usersSelected));
    ...
    $this->assertEquals($expectedReturn + 2, count($usersSelected));
